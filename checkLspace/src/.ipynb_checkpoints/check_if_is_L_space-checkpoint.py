...
def is_L_space(Man, num_iter=0, max_iter=25, max_coefficient=17, max_segms=6, max_drills=10, init_string="", already_found_inv=[], T=None, tau_T=None, which_interval=2, only_true_hyperbolic_structures=False, save_QHT=False, path_save_QHT="./proofs/", curves_to_avoid=-1):
    ...
    if found_2_L_space!=0:
        ...
        return my_boolean(found_1_L_space) and is_L_space(M_2, num_iter=num_iter+1, max_iter=max_iter, max_coefficient=max_coefficient, max_segms=max_segms, max_drills=max_drills, init_string=init_string+"2", already_found_inv=already_found_inv, save_QHT=save_QHT, path_save_QHT=path_save_QHT)
    #Otherwise we need to check both M_1 and M_2
    else:
        return is_L_space(M_2, num_iter=num_iter+1, max_iter=max_iter, max_coefficient=max_coefficient, max_segms=max_segms, max_drills=max_drills, init_string=init_string+"1", already_found_inv=already_found_inv, save_QHT=save_QHT, path_save_QHT=path_save_QHT) and is_L_space(M_1, num_iter=num_iter+1, max_iter=max_iter, max_coefficient=max_coefficient, max_segms=max_segms, max_drills=max_drills, init_string=init_string+"2", already_found_inv=already_found_inv, save_QHT=save_QHT, path_save_QHT=path_save_QHT)
